...
- 既存の実装要件定義書と設計方針書から、Junior エンジニアが迷いなく開発できるようにタスクを分割し、ドキュメントに整理する
...
- 実装要件: [specification.md へのリンク]
- 設計方針: [design-doc.md へのリンク]
```
